...
public class App {
    ...
    static Produto removerProdutoNome(ABB<String, Produto> produtosCadastrados) {
        ...
        try {
            return produtosCadastrados.remover(nomeDesejado);
        } catch (NoSuchElementException e) {
            return null;
        }
    }
    ...
    private static <K> void recortarProduto(ABB<K, Produto> produtosCadastrados, K deOnde, K ateOnde) {
        produtosCadastrados.recortar(deOnde, ateOnde);
    }

    private static void recortarProdutosNome(ABB<String, Produto> produtosCadastrados) {
        System.err.println("Digite nome de onde:");
        String item1 = teclado.nextLine();
        System.err.println("Digite nome até onde:");
        String item2 = teclado.nextLine();
        produtosCadastrados.recortar(item1, item2);
    ...
    private static void recortarProdutosId(ABB<Integer, Produto> produtosCadastrados) {
        ...
        System.err.println("Digite ID de onde:");
        Integer item1 = teclado.nextInt();
        System.err.println("Digite ID até onde:");
        Integer item2 = teclado.nextInt();
